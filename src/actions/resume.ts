...
export async function analyzeMatch(resumeText: string, jobDescription: string): Promise<{ success: boolean; data?: { matchPercentage: number; missingKeywords: string[]; tailoredBullets: string[] }; error?: string }> {
  try {
