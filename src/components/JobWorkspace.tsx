...
function EmailsTab({ emails, company }: { emails: EmailData[]; company: string }) {
  const categoryColors: Record<string, string> = {
    ...
    INTERVIEW_REMINDER: "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400",
    APPLICATION_CONFIRMATION: "bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400",
